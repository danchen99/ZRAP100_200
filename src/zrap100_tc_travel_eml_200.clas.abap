"! @testing BDEF:ZRAP100_R_TRAVELTP_200
CLASS zrap100_tc_travel_eml_200 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC
  FOR TESTING
...
CLASS ZRAP100_TC_TRAVEL_EML_200 IMPLEMENTATION.
  ...
  METHOD class_setup.
    ...
    cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds(
                      i_for_entities = VALUE #(
                        ( i_for_entity = 'ZRAP100_R_TravelTP_200' ) ) ).
  ...
  METHOD create_with_action.
    ...
    MODIFY ENTITIES OF zrap100_r_traveltp_200
     ENTITY travel
    ...
    SELECT * FROM zrap100_r_traveltp_200 INTO TABLE @DATA(lt_travel). "#EC CI_NOWHERE
